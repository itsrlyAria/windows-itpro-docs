...
> [!NOTE]
> The Update CSP functionality of 'ApprovedUpdates' is not supported for managing desktop devices. To manage updates to desktop devices from Windows Update, see the [Policy CSP - Updates](policy-csp-update.md) documentation for the recommended policies.
